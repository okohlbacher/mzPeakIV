...
- **#1 risk:** the imaging coordinate convention is NOT in the formal spec. Working hypothesis: one spectrum per pixel, x/y as scan/spectrum cvParams (imzML `IMS:1000050`/`IMS:1000051`). Confirm against the operator's real imaging `.mzpeak` before building on it. See `.planning/research/`.
